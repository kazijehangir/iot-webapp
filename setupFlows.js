...
function sendFlowRules(flow) {
    ...
    message = '{"switch":"00:00:00:00:00:00:00:01","name":"'
        ...
        '", "actions":"set_field=eth_dst->'+ flow['middleMAC'] +',set_field=ipv4_dst->'
        + flow['middleIP'] +',output='+ flow['middleIP'].split('.')[3] +'"}'
    ...
    '-rev","priority":"32768","in_port":"'+ flow['middleIP'].split('.')[3] 
        +'","active":"true", "eth_type":"0x0800","eth_src":"'
        + flow['middleMAC'] +'", "eth_dst":"'
        +flow['srcMAC']+'", "ipv4_src":"'+ flow['middleIP'] 
        +'", "ipv4_dst":"'+flow['srcIP']+
